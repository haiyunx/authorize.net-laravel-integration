            ...
            <form method="POST" action="{{ route('payments.store') }}">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="amount">
                        <option value="29.95">1 year subscription - $29.95</option>
                        <option value="51.95">2 year subscription - $51.95</option>
                        <option value="69.95">3 year subscription - $69.95</option>
                    </select>
                </div>
                <div class="form-group">
